...
public class AuthController {
    ...
    @PatchMapping("/me")
    public ApiResponse<UserProfileVo> updateMe(@RequestBody UpdateProfileRequest request) {
        Long userId = requireUserId();
    ...
    @GetMapping("/usage")
    public ApiResponse<UserUsageVo> usage() {
        Long userId = requireUserId();
        return ApiResponse.ok(userQuotaService.getAnalysisUsage(userId));
    }
