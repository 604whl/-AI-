...
public class AgentOrchestrator {
    ...
    public AgentResponse run(ChatSession session, AgentRequest request) {
        ...
        for (int step = 0; step < agentRuntimePolicy.maxSteps(); step++) {
            ...
            if (!llm.hasToolCalls()) {
                ...
                return chatHistoryService.toAgentResponse(saved);
            }
            ...
            List<ToolExecutor.ToolExecution> executions = new ArrayList<>();
